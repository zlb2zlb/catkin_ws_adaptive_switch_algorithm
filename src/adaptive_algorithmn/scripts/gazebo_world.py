...
for j in range(200):
    ...
    "
    cv2.imwrite('/home/zlb/worlds/auto_world_maps/slim_cylinder_10/world_cylinder_10_'+ str(j) + '.png', emptyImage3)
    yaml_file = "image: /home/zlb/worlds/auto_world_maps/slim_cylinder_10/world_cylinder_10_"+ str(j) + ".png \nresolution: 0.050000\norigin: [0.000000, 0.000000, 0.000000]\nnegate: 0\noccupied_thresh: 0.65\nfree_thresh: 0.196\n"
    with open('/home/zlb/worlds/auto_world_maps/slim_cylinder_10/world_cylinder_10_' + str(j) + '.yaml', 'w') as f:
        f.write(yaml_file)
    with open( '/home/zlb/worlds/auto_world_maps/slim_cylinder_10/world_cylinder_10_'+ str(j) + '.world', 'w' ) as f:
        f.write(msg)